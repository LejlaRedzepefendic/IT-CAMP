...
//INDEKSIRANJE IDE OD 0 (NULE)
// Kad se radi o stringovima krecemo od nule pa sve do (ukupna duzina -1).

//Prristupanje trecem slovu nase reci:

let treciKarakter = rec[2];
console.log (treciKarakter);


//Prevesti r4ec u sva velika slova
//Za ovaj zadatak se koristi mettoda toUpperCase()
let nova_rec = rec.toUpperCase;
console.log(nova_rec);

//Za izraunavanje duzine stringa se koristi metoda length
let duzinaRecenice = recenica.length;
console.log(duzinaRecenice)
//Ispisati duzinu reci:
console.log(rec.length)

//Ispisati r4eenicu tako da svaki karakter ide jedan ispod drugog
